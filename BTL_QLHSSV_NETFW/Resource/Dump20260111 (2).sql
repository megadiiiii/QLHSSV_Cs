...
INSERT INTO `class` VALUES ('74DT01','Điện tử viễn thông 01 - K74','DT','CNTT0012',7,10,0),('74HT01','Hệ thống thông tin 01 - K74','HT','CNTT2201',7,12,0),('74QM01','Quản trị Marketing 01 - K74','QM','QT0089',7,5,4),('75HT01','Hệ thống thông tin 01 - K75','HT','CNTT2201',5,10,1),('75KN01','Kiến trúc nội thất 01 - K75','KN','CT0016',5,10,3),('75LA01','Luật 01 - K75','LA','LCT0035',5,5,1),('75LG01','Logistics và quản lý chuỗi cung ứng 01 - K75','LG','KTVT0036',5,36,0),('76DT01','Điện tử viễn thông 01 - K76','DT','CNTT0012',4,10,0),('76EN01','Ngôn ngữ Anh 01 - K76','EN','KHUD0021',4,5,2);
...
INSERT INTO `role` VALUES (1,'K74QM0002','Lớp trưởng'),(2,'K74QM0003','Lớp phó'),(3,'K74QM0004','Bí thư'),(4,'K75KN0002','Lớp trưởng'),(9,'K75HT0001','Lớp trưởng');
...
CREATE TABLE `suspension` (
  ...
  KEY `FK_ST_SUS_idx` (`student_id`),
  CONSTRAINT `FK_ST_SUS` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `suspension` VALUES (1,'K74QM0002','2026-01-12','2026-05-06','NVQS','Đã duyệt');
...
-- Dump completed on 2026-01-12  4:10:35
